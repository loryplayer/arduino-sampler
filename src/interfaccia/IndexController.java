...
import arduino.DataCollector;
import arduino.Serial;
import arduino.SerialList;
import arduino.TimerController;
...
public class IndexController {
    ...
    /**
     * Variabile {@link SerialList}, utilizzata per memorizzare i {@link Serial} utilizzabili.
     */
    private SerialList serialUsed;
    ...
    /**
     * Variabile {@link Button} che identifica il bottone necessario per aggiornare le {@link Serial}.
     */
    @FXML
    private Button refreshInterfaceButton;
    ...
    /**
     * Variabile {@link ComboBox<Serial>}, utilizzata per immagazzinare e selezionare i {@link Serial} da utilizzare nel campionamento.
     */
    @FXML
    private ComboBox<Serial> interfaceSelector;
    ...
    /**
     * Metodo utilizzato per realizzare un {@link Thread} che si occupi della scansione delle {@link Serial} disponibili.
     * <p>
     * Ad ogni scansione vengono rimosse tutte le {@link Serial} all'interno di {@link #serialUsed}, per poi tornare ad aggiungere tutti quelle {@link Serial} identificate.
     * </p>
     * <p>
    ...
    /**
     * Metodo utilizzato per rimuovere {@link Serial} corrente da {@link #serialUsed}.
     * <p>
     * Dopo aver rimosso il {@link Driver} viene richiamato il metodo:
     * </p>
     * <ul style="margin-top:0px">
    ...
    public void removeSerialSelected() {
        this.serialUsed.remove(this.getSerialSelected());
        this.refreshSerialPortsSelector();
    }
...
//        System.out.println(this.databases_used);
    ...
    public void setSerialPortsSelectorFactory() {
        ...
        this.interfaceSelector.setCellFactory(new Callback<ListView<Serial>, ListCell<Serial>>() {
            @Override
            public ListCell<Serial> call(ListView<Serial> SerialListView) {
                return new ListCell<Serial>() {
                    @Override
                    public void updateItem(Serial db, boolean empty) {
        ...
        this.interfaceSelector.setButtonCell(new ListCell<>() {
            @Override
            public void updateItem(Serial serial, boolean empty) {
                super.updateItem(serial, empty);
                if (serial == null || empty) {
                    setText("Nessun'interfaccia disponibile");
...
//                    System.out.println(db.getName());
    ...
    /**
     * Metodo utilizzato per aggiornare i dati all'interno di {@link #serialUsed}.
     */
    public void refreshSerialPortsSelector() {
        final ObservableList<Serial> data = FXCollections.observableArrayList(
                this.serialUsed.getSerials()
        );
    ...
    /**
     * Metodo utilizzato per ottenere il {@link Serial} selezionato.
     *
     * @return {@link Serial} selezionato
     */
    public Serial getSerialSelected() {
